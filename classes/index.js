...
class Item {
 ...
 /* 
    ...
    6. The name of the key to our object
 ...
 */
    ...
    let itemTwo = new Item("Peas", "Canned", 0.89);
    ...
    let itemFour = new Item("spaghetti-os", "canned", 0.79);
 ...
 constructor(w,s){
        ...
        addTax(per) {
            ...
            let.sales_tax = Number (sellingAtCost + sellingAtCost * percentage).toFixed(2);
        }
    }

    // let itemToSell = new Expense(5,7); //class method

    let itemToSell = Expense.addUpchargeForProfit(5, .4);
    let itemToSell2 = Expense.addUpchargeForProfit(1, .2);
    let itemToSell3 = Expense.addUpchargeForProfit(5, .5);
...
// console.log(
//     `price Paid: $${itemToSell3.purchased_price.toFixed(2)}/n
//     Selling Price: $${itemTOSell3.sell_at.toFixed(2)}
//     Profit: $${(itemToSell3.sell_at - itemToSell3.
//     purchased_price).toFixed(2)} `
// );
